...
var SiteHeader_1 = __importDefault(require("../SiteHeader/SiteHeader"));
var UserFeatureRequests_1 = __importDefault(require("../../pages/UserFeatureRequests"));
var CompanyFeatureRequests_1 = __importDefault(require("../../pages/CompanyFeatureRequests"));
var RouterIndex = function (_a) {
    ...
    return (react_1["default"].createElement(react_router_dom_1.BrowserRouter, null,
        react_1["default"].createElement(SiteHeader_1["default"], null),
        react_1["default"].createElement(MenuChoiceNavBar_1.MenuChoiceNavBar, { currentPage: currentPage }),
        react_1["default"].createElement(react_router_dom_1.Routes, null,
            react_1["default"].createElement(react_router_dom_1.Route, { path: "/", element: react_1["default"].createElement(UserFeatureRequests_1["default"], null) }),
            react_1["default"].createElement(react_router_dom_1.Route, { path: "/company-feature-requests", element: react_1["default"].createElement(CompanyFeatureRequests_1["default"], null) }),
