...
var MenuChoiceNavBar = function (_a) {
    ...
    return (react_1["default"].createElement("nav", { className: 'menuChoiceNavBar' },
        react_1["default"].createElement("a", { href: "#", className: 'menuChoiceNavBar--item' }, "Vos suggestions"),
        react_1["default"].createElement("a", { href: "#", className: 'menuChoiceNavBar--item' }, "Nos id\u00E9es"),
        react_1["default"].createElement("a", { href: "#", className: 'menuChoiceNavBar--item' }, "Roadmap")));
};
