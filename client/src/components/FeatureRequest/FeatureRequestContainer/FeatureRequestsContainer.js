...
var FeatureRequestsContainer = function (_a) {
    ...
    return (react_1["default"].createElement("div", { className: 'featureRequestsContainer' },
        (0, Utils_1.isEmpty)(allFeatureRequests) && (react_1["default"].createElement("div", null, "Pas encore de feature request")),
        allFeatureRequests.error && (react_1["default"].createElement("div", null, allFeatureRequests.error)),
        !(0, Utils_1.isEmpty)(allFeatureRequests) && allFeatureRequests.map(function (featureRequest) {
