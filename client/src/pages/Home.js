...
const FeatureRequestBox_1 = require("../components/FeatureRequest/FeatureRequestBox/FeatureRequestBox");
...
const Home = () => {
    ...
    return (react_1.default.createElement("div", null,
        ...
        isToggled ? (react_1.default.createElement(FeatureRequestBox_1.FeatureRequestBox, { requestAuthorType: 'company' })) : (react_1.default.createElement(FeatureRequestBox_1.FeatureRequestBox, { requestAuthorType: 'user' }))));
};
